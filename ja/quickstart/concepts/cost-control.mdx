...
|------|--------|-------------------|----------|
| **SMALL** | gpt-5-nano<br/>claude-haiku | $0.15 - $0.25 | シンプルなクエリ、大量処理 |
| **MEDIUM** | gpt-5-mini<br/>claude-sonnet | $3.00 - $15.00 | 汎用タスク |
| **LARGE** | gpt-5.1<br/>claude-opus | $15.00 - $75.00 | 複雑な推論、重要なタスク |
...
# Shannonのルーティング付き
Shannon:
  - 70%がgpt-5-nanoにルーティング → $0.01
  - 25%がgpt-5-miniにルーティング → $0.15
  - 5%がgpt-5.1にルーティング → $0.50
...
client.submit_task(query="Pythonとは何ですか？")
client.submit_task(query="Pythonについて教えてください")
client.submit_task(query="Pythonを説明してください")
