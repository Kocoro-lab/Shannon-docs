...
<Note>HTTP ヘッダーの詳細とリクエストの例については、[/en/api/rest/authentication](/en/api/rest/authentication)を参照してください。</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="レート制限" icon="gauge" href="/en/api/overview#rate-limiting">
    レート制限とクォータを理解する
  </Card>
  <Card title="Python SDK" icon="python" href="/en/sdk/python/quickstart">
    自動認証のためにSDKを使用する
  </Card>
  <Card title="REST APIリファレンス" icon="code" href="/en/api/rest/overview">
    完全なREST APIドキュメント
  </Card>
</CardGroup>
