...
- `research_strategy` — _（非推奨: トップレベルの `research_strategy` を使用してください。contextの値はフォールバックとして読み取られます）_
- `skill` — _（非推奨: トップレベルの `skill` を使用してください。contextの値はフォールバックとして読み取られます）_
