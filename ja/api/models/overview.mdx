...
完全なリストについては [Configuration Guide](/en/quickstart/configuration) を参照してください。
...
<CardGroup cols={2}>
  <Card title="モデル選択ガイド" icon="sliders" href="/en/guides/model-selection">
    ティアルーティングとフォールバックの仕組み
  </Card>
  <Card title="構成" icon="gear" href="/en/quickstart/configuration">
    環境変数と構成ファイル
  </Card>
