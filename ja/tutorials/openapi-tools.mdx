...
<CardGroup cols={2}>
  <Card title="カスタムツールの追加" icon="wrench" href="/en/tutorials/custom-tools">
    ツール統合ガイド
  </Card>
  <Card title="ベンダーアダプター" icon="plug" href="/en/tutorials/vendor-adapters">
    ドメイン特化型統合
  </Card>
  <Card title="Shannonの拡張" icon="code-branch" href="/en/tutorials/extending-shannon">
    その他の拡張方法
  </Card>
...
- コミュニティ: [Discord](https://discord.gg/NB7C2fMcQR)
