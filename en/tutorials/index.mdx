...
<CardGroup cols={2}>
  <Card title="Research Assistant" icon="magnifying-glass" href="/en/tutorials/research-assistant">
    Build a multi-source research agent that searches, analyzes, and summarizes information
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Code Review Bot" icon="code" href="/en/tutorials/code-review-bot">
    Create an automated code reviewer that analyzes PRs and provides feedback
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Data Analysis Pipeline" icon="chart-line" href="/en/tutorials/data-analysis">
...
<CardGroup cols={2}>
  <Card title="Custom Tool Development" icon="wrench" href="/en/tutorials/custom-tools">
    Learn how to build custom tools with WASI sandboxing and MCP integration
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Multi-Agent Systems" icon="users" href="/en/tutorials/multi-agent-systems">
