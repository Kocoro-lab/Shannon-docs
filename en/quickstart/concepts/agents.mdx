...
![Agent Lifecycle](assets/agent-lifecycle.svg)
...
|------|--------|----------|------|
| **SMALL** | gpt-5-nano, claude-haiku | Simple queries, high volume | $ |
| **MEDIUM** | gpt-5-mini, claude-sonnet | General purpose | $$ |
| **LARGE** | gpt-5.1, claude-opus | Complex reasoning, critical tasks | $$$ |
