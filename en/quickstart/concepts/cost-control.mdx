...
|------|--------|-------------------|----------|
| **SMALL** | gpt-5-mini<br/>claude-haiku | $0.15 - $0.25 | Simple queries, high volume |
| **MEDIUM** | gpt-5<br/>claude-sonnet | $3.00 - $15.00 | General purpose tasks |
| <strong>LARGE</strong> | gpt-5-thinking<br/>claude-opus | $15.00 - $75.00 | Complex reasoning, critical tasks |
