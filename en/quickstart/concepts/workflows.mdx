...
description: "Understanding Shannon's workflow orchestration and cognitive patterns"
---
...
See [Configuration Guide](/quickstart/configuration) for all environment variables.
...
<CardGroup cols={2}>
  <Card title="Cost Control" icon="dollar-sign" href="/quickstart/concepts/cost-control">
    Learn budget management
  </Card>
  <Card title="Streaming" icon="stream" href="/quickstart/concepts/streaming">
    Real-time event streaming
  </Card>
  <Card title="Architecture" icon="boxes" href="/architecture/overview">
    System architecture overview
  </Card>
  <Card title="Python SDK" icon="code" href="/sdk/python/quickstart">
