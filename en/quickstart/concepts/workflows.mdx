...
![DAG Execution](assets/dag-execution.svg)
...
See [Configuration Guide](/en/quickstart/configuration) for all environment variables.
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture" icon="boxes" href="/en/architecture/overview">
    System architecture overview
  </Card>
  <Card title="Python SDK" icon="code" href="/en/sdk/python/quickstart">
