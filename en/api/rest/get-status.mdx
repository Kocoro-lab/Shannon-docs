...
| `workflow_id` | string | Workflow identifier (same as task_id) |
...
| `context` | object | Task context (budget info, date, parameters) |
| `unified_response` | object | Structured unified response with parsed result, performance metrics, and metadata |
