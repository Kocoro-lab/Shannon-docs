...
| `skill` | string | No | Markdown-defined skill to drive single-agent execution ([Skills System](/en/tutorials/skills)) |
| `research_strategy` | string | No | Research strategy preset: `quick`, `standard`, `deep`, or `academic` |
| `max_iterations` | integer | No | Maximum number of iterations for the task |
| `max_concurrent_agents` | integer | No | Maximum number of concurrent agents |
