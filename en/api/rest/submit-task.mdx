...
- `research_strategy` — _(deprecated: use top-level `research_strategy` instead; read from context as fallback)_
- `skill` — _(deprecated: use top-level `skill` instead; read from context as fallback)_
