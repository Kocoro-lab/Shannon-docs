...
- **Internal Endpoint**: The `/providers/models` endpoint is on the LLM service (port 8000). For external access, use the Gateway's OpenAI-compatible `/v1/models` endpoint (port 8080) — see [OpenAI-Compatible API](/en/api/rest/openai-compatible)
...
<CardGroup cols={2}>
  <Card title="Model Selection Guide" icon="sliders" href="/en/tutorials/model-selection">
