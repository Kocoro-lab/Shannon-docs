...
Shannon emits **real-time events** via Server-Sent Events (SSE) to provide visibility into task execution. This document catalogs the **33 event types** actually emitted by the platform, their structure, and when they occur.
