...
See [Database Schema](/architecture/database-schema#event-logs-table) for event storage details.
...
<CardGroup cols={2}>
  <Card title="Stream Task Events" icon="stream" href="/api/endpoints/stream-task">
    Streaming API endpoint
  </Card>
  <Card title="Python SDK Streaming" icon="python" href="/sdk/python/streaming">
    SDK streaming guide
  </Card>
