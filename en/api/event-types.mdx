...
| `BUDGET_THRESHOLD` | System | Token budget threshold reached |
...
**Note**: Usage metadata (tokens and cost) is now available for all providers including OpenAI, Anthropic, Google, Groq, xAI, and OpenAI-compatible endpoints.
