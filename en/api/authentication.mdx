...
<Note>For HTTP header details and request examples, see [/en/api/rest/authentication](/en/api/rest/authentication).</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="REST API Reference" icon="code" href="/en/api/rest/overview">
