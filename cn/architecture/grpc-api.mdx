...
See [Event Types Catalog](/cn/api/event-types) for all event types.
...
See [REST API Reference](/cn/api/rest/overview) for HTTP endpoints.
...
<CardGroup cols={2}>
  ...
  <Card title="Event Types" icon="stream" href="/cn/api/event-types">
    Streaming event catalog
  </Card>
  <Card title="Python SDK" icon="python" href="/cn/sdk/python/quickstart">
    Python client library
  </Card>
  <Card title="Database Schema" icon="database" href="/cn/architecture/database-schema">
    Data persistence
  </Card>
</CardGroup>
