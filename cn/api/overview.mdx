---
title: "API 概述"
description: "Introduction to Shannon"
---

> 🚧 **翻译进行中** - 此文档正在从英文翻译为中文

**原文件**: `api/overview.mdx`
**英文版本**: [查看英文文档](/en/api/overview)
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/cn/api/authentication">
    Set up API key authentication
  </Card>
  <Card title="Submit Task" icon="paper-plane" href="/cn/api/endpoints/submit-task">
