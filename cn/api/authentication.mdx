...
**原文件**: `api/authentication.mdx`
**英文版本**: [查看英文文档](/en/api/authentication)
...
<CardGroup cols={2}>
  <Card title="Submit Tasks" icon="paper-plane" href="/cn/api/endpoints/submit-task">
    Learn how to submit tasks with authentication
  </Card>
  <Card title="Rate Limiting" icon="gauge" href="/cn/api/overview#rate-limiting">
