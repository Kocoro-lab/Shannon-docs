...
**原文件**: `api/endpoints/submit-task.mdx`
**英文版本**: [查看英文文档](/en/api/endpoints/submit-task)
...
<CardGroup cols={2}>
  <Card title="Get Task Status" icon="magnifying-glass" href="/api/endpoints/get-task-status">
