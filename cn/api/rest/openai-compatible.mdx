...
| 模型 | 工作流模式 | 描述 | 默认最大 Token 数 |
|------|-----------|------|------------------|
| `shannon-chat` | Simple | 通用聊天补全（默认） | 4096 |
| `shannon-standard-research` | Research | 中等深度的平衡研究 | 4096 |
| `shannon-deep-research` | Research | 迭代精炼的深度研究 | 8192 |
| `shannon-quick-research` | Research | 简单查询的快速研究 | 4096 |
| `shannon-complex` | Supervisor | 复杂任务的多智能体编排 | 8192 |
