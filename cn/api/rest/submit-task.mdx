...
**原文件**: `api/rest/submit-task.mdx`
**英文版本**: [查看英文文档](/en/api/rest/submit-task)
...
<CardGroup cols={2}>
  <Card title="Get Task Status" icon="circle-info" href="/api/rest/get-status">
    GET /api/v1/tasks/{id}
  </Card>
  <Card title="Stream Events" icon="stream" href="/api/rest/streaming">
    Real-time task events
  </Card>
  <Card title="List Tasks" icon="list" href="/api/rest/list-tasks">
    GET /api/v1/tasks
  </Card>
