...
**原文件**: `api/rest/authentication.mdx`
**英文版本**: [查看英文文档](/en/api/rest/authentication)
...
<CardGroup cols={2}>
  <Card title="REST API Overview" icon="book" href="/cn/api/rest/overview">
    Complete API reference
  </Card>
  <Card title="Submit Task" icon="paper-plane" href="/cn/api/rest/submit-task">
    POST /api/v1/tasks
  </Card>
  <Card title="Rate Limiting" icon="gauge" href="/cn/api/rest/overview#rate-limiting">
    Rate limit details
  </Card>
  <Card title="Distributed Tracing" icon="route" href="/cn/api/rest/overview#distributed-tracing">
    Tracing setup
  </Card>
</CardGroup>
