...
**原文件**: `quickstart/configuration.mdx`
**英文版本**: [查看英文文档](/en/quickstart/configuration)
...
<CardGroup cols={2}>
  <Card title="Installation" icon="download" href="/cn/quickstart/installation">
    Initial setup guide
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="/cn/quickstart/troubleshooting">
    Common configuration issues
  </Card>
  <Card title="Cost Control" icon="dollar" href="/cn/quickstart/concepts/cost-control">
    Budget management
  </Card>
