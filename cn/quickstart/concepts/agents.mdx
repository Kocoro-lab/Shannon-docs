...
See [Configuration Guide](/cn/quickstart/configuration) for all available environment variables.
...
<CardGroup cols={2}>
  <Card title="Workflows" icon="diagram-project" href="/cn/quickstart/concepts/workflows">
