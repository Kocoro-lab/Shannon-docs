...
**原文件**: `quickstart/concepts/cost-control.mdx`
**英文版本**: [查看英文文档](/en/quickstart/concepts/cost-control)
...
<CardGroup cols={2}>
  <Card title="Streaming Events" icon="stream" href="/quickstart/concepts/streaming">
