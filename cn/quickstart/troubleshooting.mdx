...
**原文件**: `quickstart/troubleshooting.mdx`
**英文版本**: [查看英文文档](/en/quickstart/troubleshooting)
  ...
  <Accordion title="Solution 3: Using different session IDs">
    **Verify session ID consistency**:
    ...
    handle2 = client.submit_task(
        "Analyze data",
        session_id=session_id  # ← Must match!
    )
    ```
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Installation Guide" icon="download" href="/cn/quickstart/installation">
    Detailed setup instructions
  </Card>
  <Card title="API Documentation" icon="book" href="/cn/api/overview">
