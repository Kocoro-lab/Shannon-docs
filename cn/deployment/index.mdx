...
See [Installation Guide](/cn/quickstart/installation) for detailed setup instructions.
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/cn/quickstart/installation">
  ...
  <Card title="Architecture" icon="sitemap" href="/cn/architecture/overview">
...
- **Docs**: Check [Troubleshooting](/cn/quickstart/troubleshooting) for common problems
