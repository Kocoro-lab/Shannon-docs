...
**原文件**: `deployment/environment-variables.mdx`
**英文版本**: [查看英文文档](/en/deployment/environment-variables)
...
**Models Enabled**: GPT-4, GPT-4o, GPT-4o-mini, GPT-3.5-turbo
...
**Tiers**:
- `small`: GPT-4o-mini, Claude Haiku (~$0.15/1M tokens)
- `medium`: GPT-4o, Claude Sonnet (~$3-15/1M tokens)
- `large`: GPT-4, Claude Opus (~$15-75/1M tokens)
...
Retry attempts for spec fetching.
...
See [Configuration Troubleshooting](/cn/deployment/configuration-troubleshooting) for common issues.
...
<CardGroup cols={2}>
  ...
  <Card title="Security" icon="shield" href="/cn/deployment/security">
    Security hardening
  </Card>
</CardGroup>
