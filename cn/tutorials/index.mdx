...
<CardGroup cols={2}>
  <Card title="Research Assistant" icon="magnifying-glass" href="/cn/tutorials/research-assistant">
    Build a multi-source research agent that searches, analyzes, and summarizes information
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Code Review Bot" icon="code" href="/cn/tutorials/code-review-bot">
    Create an automated code reviewer that analyzes PRs and provides feedback
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Data Analysis Pipeline" icon="chart-line" href="/cn/tutorials/data-analysis">
...
<CardGroup cols={2}>
  <Card title="Custom Tool Development" icon="wrench" href="/cn/tutorials/custom-tools">
    Learn how to build custom tools with WASI sandboxing and MCP integration
    <br/>
    **Status**: 🚧 Coming Soon - Phase 4
  </Card>

  <Card title="Multi-Agent Systems" icon="users" href="/cn/tutorials/multi-agent-systems">
...
1. **Shannon Installed**: Follow the [Installation Guide](/cn/quickstart/installation)
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book" href="/cn/quickstart/concepts/agents">
    Understand Shannon's fundamentals
  </Card>

  <Card title="API Reference" icon="code" href="/cn/api/overview">
